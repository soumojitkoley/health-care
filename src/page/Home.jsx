      ...
      <div className='home-main-div'>
        <div className="home-header">
          <div className="details">
            <p><b>100+</b> Doctors</p>
            <p><b>300+</b> Hospitals</p>
            <p><b>50+</b> Blood Banks</p>
          </div>
          {
            !isMobile ? (
              <>
        ...
        <div className="home-info">
          ...
          <div className="hi hi-4">
            <h2><Fade direction='up' delay={500} triggerOnce={true}>Diagnostic Centre🦠🔬</Fade></h2>
            <p className='hi-p'><Fade direction='up' delay={500} triggerOnce={true}>Diagnostic centers offer a wide range of tests and screenings that can detect diseases and conditions in their early stages.</Fade></p>
          </div>
          <div className="hi hi-5">
            <h2><Fade direction='up' delay={500} triggerOnce={true}>Blood Bank🩸</Fade></h2>
            <p className='hi-p'><Fade direction='up' delay={500} triggerOnce={true}>Diagnostic centers offer a wide range of tests and screenings that can detect diseases and conditions in their early stages.</Fade></p>
          </div>
        </div>
        ...
        <div className='service-part' id='svc'>
          <div className="services">
            ...
            <div className="service-hospital">
              ...
              <p><Fade direction='up' delay={500} triggerOnce={true}>Experience unparalleled medical services at our hospitals equipped with advanced technology and skilled healthcare professionals.</Fade></p>
            ...
            <div className="service-bloodbank">
              <h1><Fade direction='up' delay={500} triggerOnce={true}>Best Blood Banks</Fade></h1>
              <p><Fade direction='up' delay={500} triggerOnce={true}>Explore our extensive network of blood banks dedicated to providing safe and reliable blood transfusion services for every patient's needs.</Fade></p>
              <Link to='/blood-bank' className='none'>
                <Fade direction='up' delay={500} triggerOnce={true}>
                  <button>
                    Check Blood Banks
